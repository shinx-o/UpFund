    ...
    <div className="manager-dashboard-container">
      <div className="top">
        <div className="total-amount top-entity">
          ...
          <span className="text-data">₹{formatNumber(getTotalInvestment())}</span>
        </div>
        <div className="current-value top-entity">
          <h3>Number Of Funds</h3>
          <span className="text-data">{mutualFundsList.length}</span>
        </div>
        ...
        <div className="invest-btn-container top-entity">
          <Link to="/createMutualFund">
            <button className="invest-button">Create</button>
          </Link>
        </div>
      </div>
              ...
              mutualFundsList.map((row, idx) => {
                ...
                return (
                  <div
                    ...
                    style={{
                      borderBottom: `${
                        idx === mutualFundsList.length - 1 && "none"
                      }`,
                    }}>
                    ...
                    <div className="funds-folio-number fund-entity">
                      ...
                      <span className="fund-entity-details">
                        {row.mutualFundId}
                      </span>
                    </div>
                    ...
                    <div className="funds-redeem fund-entity">
                      <Link to={`mutualfund/${row.mutualFundId}`}>
